              ...
              Some of my achievements during my study.
						...
						<div className="flex items-center gap-4 mb-4">
							...
							<div>
								...
								Graduation - B.B.M.K. University ( 2021 to 2022 )
								</h3>
								<p className="text-sm">
								I paused my graduation degree due to family reasons,
								</p>
							</div>
						</div>
						<div className="flex items-center gap-4 mb-4">
							...
							<div>
								<h3 className="font-medium">
								12th - D.A.V. Public School — Completed in 2020
								</h3>
								<p className="text-sm">
								Percentage: 54%
								</p>
						...
						<div className="flex items-center gap-4 mb-4">
							...
							<div>
								<h3 className="font-medium">
								10th - S.S.V.M. School — Completed in 2018
								</h3>
								<p className="text-sm">
								Percentage: 65%
